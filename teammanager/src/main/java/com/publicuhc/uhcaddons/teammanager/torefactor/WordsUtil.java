...
public class WordsUtil {
    ...
    private WordsUtil(Configurator manager){
        Optional<FileConfiguration> configOptional = manager.getConfig("words");

        if(!configOptional.isPresent()) {
            throw new IllegalStateException("Cannot find words.yml file for creating team names");
        }

        FileConfiguration config = configOptional.get();
